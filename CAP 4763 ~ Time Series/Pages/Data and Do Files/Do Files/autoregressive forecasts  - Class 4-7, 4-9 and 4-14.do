...
*Mini Lecture 1 -  AR models and the arima command
...
*Mini Lecture 2 - using ARIMA for dynamic forecasting - Model Comparison
...
*Mini Lecture 4 - Dynamic Arima Forecast Fan Chart
...
*Mini Lecture 5 - Seasonal Differencing and AR - the Math

	
	
*Mini Lecture 6 - Seasonal Differencing and AR models in Stata
